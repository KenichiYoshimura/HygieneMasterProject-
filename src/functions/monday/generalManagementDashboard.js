...
*/
async function uploadToMondayGeneralManagementBoard(rowData, context, base64BinFile, originalFileName) {
  logMessage("🚀 uploadToMondayGeneralManagementBoard() called", context);
  ...
  const columnValues = stripUndefined({
    ...
    color_mkv5fa8m: rowData.color_mkv5fa8m,
    color_mkv59ent: rowData.color_mkv59ent,
...
module.exports = {
  uploadToMondayGeneralManagementBoard
};
